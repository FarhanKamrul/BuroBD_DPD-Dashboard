...
- Copy that dataframe to create 5 different dataframes titled: '7+ DPD', '15+ DPD', '30+ DPD', '60+ DPD', '90+ DPD'
...
def main():
    ...
    while True:
        ...
        filterVal = input("Enter minimum DPD Filter Value (press 'e' to exit): ")

        # Check if the user wants to exit
        if filterVal.lower() == 'e':
        ...
        try:
            ...
            print("Invalid input. Please enter a valid numeric value or 'e' to exit.")
            continue

        # Initialize visualDf inside the loop
